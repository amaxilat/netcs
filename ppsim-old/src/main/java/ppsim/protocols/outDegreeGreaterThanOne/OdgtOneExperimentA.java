...
* Created at:  28 Αυγ 2011 5:11:04 μμ
...
/**
* Implementation of an experiment of the Out-Degree-Greater-Than-1 protocol.
*/
public class OdgtOneExperimentA extends AbstractExperiment<OdgtOneState, OdgtOneProtocol>  {
     ...
     */
    public OdgtOneExperimentA(final Scheduler<OdgtOneState> scheduler, final int size) {
            ...
            //for (int sched = 7; sched < 15; sched++) {
                ...
                final int sched = SchedulerFactory.GNP_EDGE;
                    ...
                    try {
                        ...
                        final OdgtOneExperimentA exp = new OdgtOneExperimentA(scheduler, size);
