 ...
 */
public class NewStateScheduler<State> extends AbstractSchedulerNew<State> {
    ...
    public void interact() {
        ...
        final AbstractAgent<State> finalRespAgent = respAgent;
        interact(initAgent, respAgent, new AbstractAgent<State>() {
            @Override
            protected void initAgent() {
                setState(finalRespAgent.getState());
            }
        });
    }
