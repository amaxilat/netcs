...
public class StatePair<State> {
     ...
     */
    public StatePair(final State init, final State resp) {
        this.initiator = init;
        this.responder = resp;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final StatePair otherPair = (StatePair) obj;

        return ((getInitiatorState().equals(otherPair.getInitiatorState())) && (getResponderState().equals(otherPair.getResponderState())));
    }
